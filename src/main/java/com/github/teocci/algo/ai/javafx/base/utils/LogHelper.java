...
import static com.github.teocci.algo.ai.javafx.base.utils.Config.LOG_PREFIX;
...
public class LogHelper
{
    ...
    {
        String message = process(t, messages);

        LOG.println(tag + ": " + message);
    }

    public static void err(String tag, Throwable t, Object... messages)
    {
        String message = process(t, messages);
    ...
    public static String process(Throwable t, Object... messages)
    {
        String message;
